...
function updateDirectionLabels() {
  ...
  if (
    ...
    headerEnEl.textContent =
      'Arrivals';

    headerJaEl.textContent =
      '到着';

    scheduleJaEl.textContent =
      '到着時刻';

    locationEnEl.textContent =
      'Origin';

    locationJaEl.textContent =
      '出発地';
    ...
    async function () {
      ...
      try {
        ...
        console.warn(
          ...
          'Could not save direction selection'
